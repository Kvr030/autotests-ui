...
class CoursesListPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.course_edit_menu_button = page.get_by_test_id('course-view-edit-menu-button')
        self.course_delete_menu_button = page.get_by_test_id('course-view-delete-menu-button')
    ...
    def check_visible_empty_view(self):
        ...
        expect(self.empty_view_description).to_be_test('Results from the load test pipline will be displayed here')
    ...
    def check_visible_course_card(self,
        ...
        expect(self.course_title.nth(index)).to_be_have_text(title)
        ...
        expect(self.course_estimated_time_text.nth(index)).to_be_have_text(f'Estimated time: {estimated_time}')
