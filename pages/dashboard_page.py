...
class DashboardPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.student_title = page.get_by_test_id('student-widget-title-text')
        self.student_chart = page.get_by_test_id('student-bar-chart')
        ...
        self.courses_chart = page.get_by_test_id('course-pie-chart')
    ...
    def check_visible_students_chart(self):
        ...
        expect(self.student_title).to_have_text('Student')
